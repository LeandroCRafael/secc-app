...
export default function ComparePage() {
  ...
  return (
    <main className="shell page">
      ...
      <h1>{companies.length} trajetórias alinhadas pelo momento do evento.</h1>
      ...
      <section className="section table-wrap">
        <table className="public-comparison-table">
          <thead><tr><th>Empresa</th><th>Ano t-1</th><th>Receita</th><th>Margem EBIT</th><th>Liquidez</th><th>PL / ativos</th><th>Índice</th></tr></thead>
      ...
      <section className="section grid three">
        ...
        <article className="card"><p className="eyebrow">Limite</p><h3>O índice não ordena qualidade de crédito.</h3><p>A régua resume dimensões definidas pelo modelo experimental (maior = mais saudável) e não substitui contexto qualitativo ou validação estatística.</p></article>
      </section>
