...
export default async function ResearchPage() {
  ...
  try {
    ...
    return <><header className="admin-title"><p className="eyebrow">Entrada manual · PostgreSQL</p><h1>Banco operacional indisponível.</h1></header><p className="notice" role="alert">Verifique a conexão do ambiente antes de cadastrar registros.</p></>;
  }
