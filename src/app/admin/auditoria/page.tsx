...
export default async function AuditPage() {
  ...
  try {
    ...
    return <><header className="admin-title"><p className="eyebrow">Trilha imutável</p><h1>Banco operacional indisponível.</h1></header><p className="notice" role="alert">Inicie o PostgreSQL local para consultar a auditoria.</p></>;
  }
